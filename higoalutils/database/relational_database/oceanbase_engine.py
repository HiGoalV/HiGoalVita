...
class OceanBaseEngine(DatabaseEngineBase):
    def __init__(self):
        cfg = get_config().database_config.oceanbase_relational_config
        uri = f"mysql+asyncmy://{cfg.user}:{cfg.password}@{cfg.host}:{cfg.port}/{cfg.database}?ssl=false" # type: ignore
