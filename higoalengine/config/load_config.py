...
from higoalengine.config.models.engine_config import EngineConfig


cfg = get_config()
EngineConfigManager = ConfigFactory(
    config_class=EngineConfig, 
    config_dir= f"{cfg.base_config.root_dir}/{cfg.base_config.config_dir}", 
    config_file=cfg.config_file_config.config_file_for_engine
)

def get_engine_config() -> EngineConfig:
    return EngineConfigManager.get_config()